...
export const themeLight = {
  ...
  colors: {
    ...
    themeSwitch: {
      ...
      border: colorNames.mineShaft,
    },
    buttonBg: colorNames.tundora,
...
export const themeDark = {
  ...
  colors: {
    ...
    tile: {
      ...
      header: colorNames.dodgerBlue,
    },
    themeSwitch: {
      background: colorNames.mineShaftLighter,
      border: colorNames.white,
    },
    buttonBg: colorNames.mercury,
    buttonText: colorNames.mineShaft,
  },
};
